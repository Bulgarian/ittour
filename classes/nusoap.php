  ...
  */
  ...
  function serializeRPCParameters($operation, $direction, $parameters)
  {
    ...
    if (isset($opData[$direction]['parts']) && sizeof($opData[$direction]['parts']) > 0) {
      if(!isset($opData[$direction]['use'])){
        $opData[$direction]['use'] = 'encoded';
      }
...
* @access   public
*/
class nusphere_soapclient extends nusoap_base  {
  ...
  * @access   public
  */
  function nusphere_soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
    parent::nusoap_base();
  ...
  */
  function call($operation,$params=array(),$namespace='http://tempuri.org',$soapAction='',$headers=false,$rpcParams=null,$style='rpc',$use='encoded'){
    ...
    if($this->endpointType == 'wsdl' && $opData = $this->getOperationData($operation)){
      ...
      $style = $opData['style'];
      if(!isset($opData['input']['use'])){
        $opData['input']['use'] = 'encoded';
      }
  ...
  */
  ...
  ";
    ...
    $evalStr = 'class soap_proxy_'.$r.' extends nusphere_soapclient {
  '.$evalStr.'
}';
    return $evalStr;
  }
